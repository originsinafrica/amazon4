...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Amazones — Origins in Africa" },
      { name: "description", content: "Présentation des projets des Amazones et village des contributions." },
      { name: "author", content: "Origins in Africa" },
      { property: "og:title", content: "Amazones — Origins in Africa" },
      { property: "og:description", content: "Présentation des projets des Amazones et village des contributions." },
